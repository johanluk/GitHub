...
#End Region
    ...
    Sub DisplayTransaction()
        ...
        Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID_Header)), 3, 0)
    ...
    Private Sub Bt_SaveDetail_Click(sender As Object, e As EventArgs) Handles Bt_SaveDetail.Click
        Try
            ...
            Me.QueriesTableAdapter.sp_PDProductionDailyDetail_InsUpdData(3, 0, Ed_ProductionNo.Tag, LookUpEdit_HenHouse.EditValue, LookUpEdit_Shift.EditValue,
                                                                         LookUpEdit1.EditValue, 0, Ed_Weight.EditValue, CDbl(Ed_Weight.EditValue),
                                                                         Memo_DescDet.EditValue, UserModified, Now)
            Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID_Header)), 3, LookUpEdit_HenHouse.EditValue)
