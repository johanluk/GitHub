...
#End Region
    ...
    Function ValidationCheck() As Boolean
        Try
            ...
            If (Ed_Qty.EditValue = 0) Then
                DxErrorProvider1.SetError(Ed_Qty, "Weight cannot be 0", DevExpress.XtraEditors.DXErrorProvider.ErrorType.Warning)
            End If
    ...
    Sub DisplayTransaction()
        ...
        Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID)), 3, 0)
    ...
    Private Sub Frm_MDDailyEgg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Sp_PDProductionDailyDetail_GetComponentTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetComponent, 3)
    ...
    Private Sub Bt_SaveDetail_Click(sender As Object, e As EventArgs) Handles Bt_SaveDetail.Click
        Try
            AlertParamName = LookUpEdit1.Text.ToString() + " Berhasil Diinput"
            ...
            Me.QueriesTableAdapter.sp_PDProductionDailyDetail_InsUpdData(3, 0, Ed_ProductionNo.Tag, LookUpEdit_HenHouse.EditValue, 3,
                                                                         LookUpEdit1.EditValue, Ed_Qty.EditValue, 0, 0,
                                                                         Memo_DescDet.EditValue, UserModified, Now)
            Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID)), 3, LookUpEdit_HenHouse.EditValue)
