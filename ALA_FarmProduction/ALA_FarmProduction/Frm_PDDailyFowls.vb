...
#End Region
    ...
    Function ValidationCheck() As Boolean
        Try
            ...
            If (Ed_Qty.EditValue = 0) Then
                DxErrorProvider1.SetError(Ed_Qty, "Price cannot be 0", DevExpress.XtraEditors.DXErrorProvider.ErrorType.Warning)
            End If
    ...
    Sub DisplayTransaction()
        ...
        Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID_Header)), 0, 0)
    ...
    Private Sub Frm_MDDailyEgg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Sp_PDProductionDailyDetail_GetComponentTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetComponent, 0)
    ...
    Private Sub Bt_SaveDetail_Click(sender As Object, e As EventArgs) Handles Bt_SaveDetail.Click
        Try
            AlertParamName = LookUpEdit_HenHouse.Text + " : " + LookUpEdit1.Text
            ...
            Me.QueriesTableAdapter.sp_PDProductionDailyDetail_InsUpdData(0, 0, Ed_ProductionNo.Tag, LookUpEdit_HenHouse.EditValue, 2,
                                                                         LookUpEdit1.EditValue, CDbl(Ed_Qty.EditValue), 0, 0,
                                                                         Memo_DescDet.EditValue, UserModified, Now)
            Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID_Header)), 0, LookUpEdit_HenHouse.EditValue)
