...
Public Class Frm_PDDailyOverHead
...
#End Region
    ...
    Sub DisplayTransaction()
        ...
        Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID_Header)), 5, 0)
    ...
    Private Sub Frm_MDDailyEgg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Sp_PDProductionDailyDetail_GetComponentTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetComponent, 5)
    ...
    Private Sub Bt_SaveDetail_Click(sender As Object, e As EventArgs) Handles Bt_SaveDetail.Click
        Try
            ...
            Me.QueriesTableAdapter.sp_PDProductionDailyDetail_InsUpdData(5, 0, Ed_ProductionNo.Tag, LookUpEdit_HenHouse.EditValue, 3,
                                                                         LookUpEdit1.EditValue, 0, 0, CDbl(Ed_Price.EditValue),
                                                                         Memo_DescDet.EditValue, UserModified, Now)
            Me.Sp_PDProductionDailyDetail_GetDataTableAdapter.Fill(Me.DataSet.sp_PDProductionDailyDetail_GetData, CInt(GV_Header.GetFocusedRowCellValue(colID_Header)), 5, LookUpEdit_HenHouse.EditValue)
